<%@ Page Title="" Language="VB" MasterPageFile="~/MainAdmin.master" AutoEventWireup="false" CodeFile="4kolom.aspx.vb" Inherits="FClass_Maximo_Index" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="page-title">
        <h3>
            <asp:Label ID="lblPageName" runat="server">Failur Class Maximo 4 Kolom</asp:Label></h3>
